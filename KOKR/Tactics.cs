...
namespace KOKR
{
    class Tactics
    {
        ...
        {
            if (!ObviousAttack(P, Pole.Green, true))
           ...
           // if (!DefenceMakingObviousAttack(P, Pole.Green, true))
        ...
        private bool DefenceMakingObviousAttack(Pole[,] P, Pole Colour, bool sure)
        {
            for (int i = 0; i < 15; i++)
                for (int j = 0; j < 15; j++)
                {
        ...
        private bool PreparingMakingObviousAttack (Pole[,] P, Pole Colour, bool sure)
        {
            ...
            for (int i=0; i<15; i++)
                for (int j=0; j<15; j++)
                {
                    ...
                    {
                        moving.move(P, Colour, ref i, ref j);
                        if (MakingObviousAttack(P, Colour, false, sure))
                        {
                            return true;
                        }
                        moving.Redo(P);
